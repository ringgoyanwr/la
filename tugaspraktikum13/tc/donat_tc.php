...
<body>
    ...
    <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Total Cases</button>
    	<div class="dropdown-menu">
    		...
    		<a class="dropdown-item" href="bar_tc.php">Bar Chart</a>
    		<a class="dropdown-item" href="pie_tc.php">Pie Chart</a>
    		<a class="dropdown-item" href="donat_tc.php">doughnut Chart</a>
  		</div>
  	</div>
  	<div class="btn-group">

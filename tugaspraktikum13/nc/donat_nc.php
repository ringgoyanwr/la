...
while($row = mysqli_fetch_array($produk)){
	...
	$query = mysqli_query($koneksi,"select sum(nc) as total_case from tb_case where id_negara='".$row['id_negara']."'");
...
<body>
	<h2>New Cases  <span class="badge badge-info">Doughnut Chart</span></h2>
    ...
    <button class="btn btn-outline-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">New Cases</button>
    	<div class="dropdown-menu">
    		...
    		<a class="dropdown-item" href="bar_nc.php">Bar Chart</a>
    		<a class="dropdown-item" href="pie_nc.php">Pie Chart</a>
    		<a class="dropdown-item" href="donat_nc.php">doughnut Chart</a>
  		</div>

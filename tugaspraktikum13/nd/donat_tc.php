...
while($row = mysqli_fetch_array($produk)){
	...
	$query = mysqli_query($koneksi,"select sum(nd) as total_case from tb_case where id_negara='".$row['id_negara']."'");
...
<body>
	<h2>Total Cases <span class="badge badge-secondary">Doughnut Chart</span></h2>
    ...
    <button class="btn btn-outline-warning dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">New Deaths</button>
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="bar_nd.php">Bar Chart</a>
        <a class="dropdown-item" href="pie_nd.php">Pie Chart</a>
        <a class="dropdown-item" href="donat_nd.php">doughnut Chart</a>
      </div>
    </div><div class="btn-group">

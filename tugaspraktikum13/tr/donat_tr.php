...
while($row = mysqli_fetch_array($produk)){
	...
	$query = mysqli_query($koneksi,"select sum(tr) as total_case from tb_case where id_negara='".$row['id_negara']."'");
...
<body>
	<h2>Total Recovered <span class="badge badge-success">doughnut Chart</span></h2>
    ...
    <button class="btn btn-outline-danger dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Total Deaths</button>
      <div class="dropdown-menu">
        <a class="dropdown-item" href="../td/index.php">Line Chart</a>
        <a class="dropdown-item" href="../td/bar_td.php">Bar Chart</a>
        <a class="dropdown-item" href="../td/pie_td.php">Pie Chart</a>
        <a class="dropdown-item" href="../td/donat_td.php">doughnut Chart</a>
      </div>
    ...
    <button class="btn btn-outline-success dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Total Recovered</button>
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="bar_tr.php">Bar Chart</a>
        <a class="dropdown-item" href="pie_tr.php">Pie Chart</a>
        <a class="dropdown-item" href="donat_tr.php">doughnut Chart</a>
      </div>
    </div><div class="btn-group">

...
while($row = mysqli_fetch_array($produk)){
	...
	$query = mysqli_query($koneksi,"select sum(ac) as total_case from tb_case where id_negara='".$row['id_negara']."'");
...
<body>
	<h2>Active Cases <span class="badge badge-dark">doughnut Chart</span></h2>
    ...
    <button class="btn btn-outline-dark dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Active Cases</button>
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="bar_ac.php">Bar Chart</a>
        <a class="dropdown-item" href="pie_ac.php">Pie Chart</a>
        <a class="dropdown-item" href="donat_ac.php">doughnut Chart</a>
      </div>
    </div>
  <br>
  <br>
